...
public class StatusEvent {
    ...
    public boolean statusBolusExtendedInProgress;
    public int statusBolusExtendedDurationInMinutes;
    public int statusBolusExtendedDurationSoFarInMinutes;
    public double statusBolusExtendedPlannedAmount;
